...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="css/style.css">
    ...
    <title>RavenDB Item-Exchange</title>
...
<nav class="navbar navbar-fixed-top">
 ...
 <div class="navbar-header">
      <a class="navbar-brand" href="#" style='font-size:20px;color:white;'>RavenDB Items-Exchange</a>
    </div>
...
<button class="category_post1">Home</button></a></li>
 ...
 <li style='' class="navgate_no"><a title='Signup' href="signup_admin.php" style="color:white;font-size:14px;">
<button class="category_post1">Admin Signup</button></a></li>
...
<br><span style='font-size:20px;'>Admin Login System</span><br><br>
</center>
...
<span class="fa fa-envelope-o"></span>Email</label>
              <input type="text" class="col-sm-12 form-control" id="email" name="email" placeholder="Enter email" value="esedofredrick@gmail.com">
            </div>
