...
<h3><center > <b style='color:#800000'>My Published Products</b></center></h3>
...
curl_setopt($ch2, CURLOPT_POSTFIELDS, "{ \n    \"Query\":\"from $product_tb where userid = '$userid_sess'\" \n}");
...
if($TotalResults == 0){
echo "<div class='alerts_fades' style='background:red;color:white;padding:10px;border:none;'>No Products Published by You Yet..... </div>";
