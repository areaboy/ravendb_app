...
/*
if($result2 ==''){
$return_arr = array("msg"=>"internet_error", "msg2"=>"Please Ensure there is Internet Connection and Try Again...");
echo json_encode($return_arr);
exit();
}
*/
...
$return_arr = array("msg"=>"rating_already");
echo json_encode($return_arr);
exit();
...
curl_setopt($ch2, CURLOPT_HTTPHEADER, $headers2x);
...
$return_arr = array("rating"=>$total_rating_sum_round, "msg"=>"success");
echo json_encode($return_arr);
